...
export default function CustomShadows(palette: Palette) {
  return {
    ...
    z1: `0px 1px 4px ${withAlpha(palette.grey[900] as string, 0.08)}`,
    ...
    grey: `0 0 0 2px ${withAlpha(palette.grey[500] as string, 0.2)}`,
    ...
    greyButton: `0 14px 12px ${withAlpha(palette.grey[500] as string, 0.2)}`
  };
}
