...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'menu.mail': '메일 관리',
    'menu.mail.send': '메일 발송',
    'menu.mail.auto': '자동 메일',
    'menu.mail.manual': '수동 메일',
    'menu.mail.management': '발송 관리',
  ...
  en: {
    ...
    'menu.mail.send': 'Mail Sending',
    'menu.mail.auto': 'Auto Mail',
    'menu.mail.manual': 'Manual Mail',
    'menu.mail.management': 'Sending Management',
    ...
    'breadcrumb.member': 'Member Management',
  ...
  vi: {
    ...
    'breadcrumb.member': 'Quản lý Thành viên',
